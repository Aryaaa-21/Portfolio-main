...
export default function Navbar({ theme, toggleTheme }) {
  ...
  const navLinks = [
    ...
    { label: 'Achievements', path: '/certificates' },
  ];

  return (
    <nav className="fixed top-4 left-1/2 -translate-x-1/2 w-[calc(100%-32px)] max-w-7xl z-50 rounded-none bg-surface/10 dark:bg-surface-dark/15 backdrop-blur-xl border border-border/40 dark:border-border-dark/40 px-6 py-4 theme-transition">
